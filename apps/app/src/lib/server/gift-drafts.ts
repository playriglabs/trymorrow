 ...
 * cash fee for it rides in the same transaction. The send screen and tips from X both come here.
 */
export async function createGiftDrafts(sender: UserRow, body: GiftDraftInput) {
  ...
  return { gifts, feePaidInShares: plan.asset != null }
}
